[![build status](https://github.com/dargmuesli/creal/workflows/Docker%20CI/badge.svg)](https://github.com/dargmuesli/creal/actions?query=workflow%3ADocker%20CI "build status")
