...
FROM node:19.8.1-slim@sha256:bd3c421bc8702b864a674bd1825c7fa7fa62e9e07d4ab2fa477581d47be4333e AS development
...
# Should be the specific version of `node:slim`.
FROM node:19.8.1-slim@sha256:bd3c421bc8702b864a674bd1825c7fa7fa62e9e07d4ab2fa477581d47be4333e AS prepare
...
FROM node:19.8.1-slim@sha256:bd3c421bc8702b864a674bd1825c7fa7fa62e9e07d4ab2fa477581d47be4333e AS build
...
# Should be the specific version of `node:slim`.
# Could be the specific version of `node:alpine`, but the `prepare` stage uses slim too.
FROM node:19.8.1-slim@sha256:bd3c421bc8702b864a674bd1825c7fa7fa62e9e07d4ab2fa477581d47be4333e AS lint
...
# Should be the specific version of `node:slim`.
# Could be the specific version of `node:alpine`, but the `prepare` stage uses slim too.
FROM node:19.8.1-slim@sha256:bd3c421bc8702b864a674bd1825c7fa7fa62e9e07d4ab2fa477581d47be4333e AS collect
...
# Should be the specific version of `node:slim`.
# `sqitch` requires at least `buster`.
FROM node:19.8.1-slim@sha256:bd3c421bc8702b864a674bd1825c7fa7fa62e9e07d4ab2fa477581d47be4333e AS production
